...
//        console.log("" + totalIndex1 + "|" + model_lev1.myLabel.labelName + ":" + model_lev1.myLabel.labelCode);
//
//        // 第二階層
...
//            console.log("" + totalIndex1 + "|" + model_lev2.myLabel.labelName + ":" + model_lev2.myLabel.labelCode);
//
//            // 第三階層
...
//     //
//     totalIndex = 0;
//     for(totalIndex = 0 ; totalIndex < totalList.size() ; totalIndex++){
//       console.log(totalList.toArray()[totalIndex].myLabel.labelName);
//     }
//     //
//     console.log('----------------:' + totalList.size());
//     totalIndex = 0;
//     totalList.forEach( function(e)
//       { console.log(e.myLabel.labelName)}
//     );
  ...
  nestMethod2(message :string,totalIndex1 :number,totalList :Collections.LinkedList<MLabelModel>,e2 :any) :void{
    let myLabel2 = new MLabel (
             e2.companyCode
             ,e2.parentLabelCode
             ,e2.labelCode
  ...
  private method2() :void{
    ...
    this.nestMethod("第一階層",1,null,null);

    // // 第一階層
     _.forEach(lev1List, function(e) {
       totalIndex1++;
       console.log("" + totalIndex1 + "|" + e.labelName + ":" + e.labelCode);
    //   this.nestMethod("第一階層",totalIndex1,totalList,e);
    //
    //   // 第二階層
    //   _.forEach(lev2List, function(e2) {
    //     if(e2.parentLabelCode === e.labelCode){
    //       totalIndex1++;
    //       //console.log("" + totalIndex1 + "| " + e2.labelName + ":" + e2.labelCode);
    //       this.nestMethod("第二階層",totalIndex1,totalList,e2);
    //
    //       // 第三階層
    //        _.forEach(lev3List, function(e3) {
    //         if(e3.parentLabelCode === e2.labelCode){
    //           totalIndex1++;
    //           //console.log("" + totalIndex1 + "|  " + e3.labelName + ":" + e3.labelCode);
    //           this.nestMethod("第三階層",totalIndex1,totalList,e3);
    //           // 第四階層
    //           _.forEach(lev4List, function(e4) {
    //             if(e4.parentLabelCode === e3.labelCode){
    //               totalIndex1++;
    //               //console.log("" + totalIndex1 + "|   " + e4.labelName + ":" + e4.labelCode);
    //               this.nestMethod("第四階層",totalIndex1,totalList,e4);
    //               // 第五階層
    //               _.forEach(lev5List, function(e5) {
    //                 if(e5.parentLabelCode === e4.labelCode){
    //                  totalIndex1++;
    //                  //console.log("" + totalIndex1 + "|    " + e5.labelName + ":" + e5.labelCode);
    //                  this.nestMethod("第五階層",totalIndex1,totalList,e5);
    //                 }
    //               });
    //             }
    //           });
  ...
  nestMethod(message :string,totalIndex1 :number,totalList :Collections.LinkedList<MLabelModel>,e2 :any) :void{
    console.log("hoge");
  }
}
